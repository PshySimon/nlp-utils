...
class Trainer:
    ...
    def can_resume(self):
        ...
        for file in state_files:
            cur_file = os.path.join(self.train_config.train_state_dir, file)
            matching_files = glob.glob(cur_file)
    ...
    def train(self, resume=True):
        ...
        if resume:
            if self.can_resume():
                ...
                self.log("Cannot resume from state dict because state dir is empty, loading from scratch instead")
        # --------------------------------------------------------------------------------
